import json
import sys
from PyQt5.QtWidgets import QApplication, QWidget, QMainWindow,QLabel, QPushButton, QVBoxLayout, QLineEdit
...
class ProvinceDetectorApp(QMainWindow):
    def __init__(self):
        ...
        self.detector = ProvinceDetector(json_path)
...
class ProvinceDetector:
    ...
    def is_valid_national_code(self, code: str) -> bool:
    ...
    def detect(self, national_code: str):
        if not self.is_valid_national_code(national_code):
